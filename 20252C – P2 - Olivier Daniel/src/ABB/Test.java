...
public class Test {
	...
	public static void main(String[] args) {
		...
		Integer Nombre1 = 1;
		Integer Nombre2 = 3;
		System.out.println("La comparación es: "+Nombre1.compareTo(Nombre2));
		Comparator d = new DefaultComparator<Integer>();
		System.out.println("La comparación 2 es: "+d.compare(Nombre1, Nombre2));
		...
		*/
		...
		System.out.println("antes de borrar 20");
		System.out.println(t);
		t.eliminar(20);
		System.out.println("luego de borrar 20");
		System.out.println(t);
	}
	
	private static void insertar_imprimir( arbolBB<Integer> t, int x ) {
